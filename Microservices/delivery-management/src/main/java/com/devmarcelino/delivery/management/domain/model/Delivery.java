...
@Getter
public class Delivery extends AbstractAggregateRoot{
    ...
    private BigDecimal destanceFee;
    ...
    public static Delivery draft() {
        ...
        delivery.setDestanceFee(BigDecimal.ZERO);
        return delivery;
    }
    ...
    private void changeStatusTo(DeliveryStatus newStatus){
        if (newStatus != null && this.getStatus().canNotChangeTo(newStatus)) {
            throw new DomainException(
                "Invalid status trasition from " + this.getStatus() + " to " + newStatus
            );
        }
